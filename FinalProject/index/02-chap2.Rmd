...
# load model
boost_wine <- readr::read_rds("~/git/Stat495-F19-GroupD/FinalProject/index/data/boost_wine500.rds")
...
# load model
boost_wine_words <- readr::read_rds("~/git/Stat495-F19-GroupD/FinalProject/index/data/boost_wine_words.rds")
